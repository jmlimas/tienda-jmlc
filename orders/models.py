...
class Order(models.Model):
    ...
    contry = models.CharField(max_length=70)
    order_note = models.CharField(max_length=100, blank=True)
    order_total = models.FloatField()
    tax = models.FloatField()
    status = models.CharField(max_length=50, choices=STATUS, default='New')
    ip = models.CharField(blank=True, max_length=20)
    is_ordered = models.BooleanField(default=False) #ya  fue  ordenada
...
class OrderProduct(models.Model):
    ...
    payment = models.ForeignKey(Payment, on_delete=models.CASCADE) #pago
    user = models.ForeignKey(Account, on_delete=models.CASCADE)
    ...
    ordered = models.BooleanField(default=False) # esta  siendo  ordenado
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
